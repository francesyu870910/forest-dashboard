...
import { Flame, Eye, EyeOff, Lock, User, Mail, ArrowRight, KeyRound, AlertCircle, Trees } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogDescription,
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">森林防火监控平台</h1>
              <p className="text-sm text-slate-400">综合管控系统</p>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Trees className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-slate-400" />
                  <Input
                    id="username"
                    type="text"
                    placeholder="请输入用户名"
