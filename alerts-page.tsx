...
interface Alert {
  id: string
  type: "火情" | "高温" | "烟雾" | "干旱" | "设备" | "其他"
  level: "高危" | "中危" | "低危"
  location: string
  device: string
  timestamp: string
  status: "未处理" | "处理中" | "已处理" | "已关闭"
  description: string
  image?: string
}
...
export default function AlertsPage() {
  ...
  const [alerts] = useState<Alert[]>([
    {
      ...
      status: "处理中",
      description: "卡拉乡监测站检测到明火，火势正在蔓延，请立即处理。",
      image: "/fire-alert-1.jpg",
    },
    {
      id: "A002",
      type: "烟雾",
      ...
      location: "木里县博窝乡",
      device: "博窝乡监测站",
      timestamp: "2025-06-02 10:25:30",
      status: "未处理",
      description: "博窝乡监测站检测到大量烟雾，可能存在火灾隐患，请尽快确认。",
      image: "/smoke-alert-1.jpg",
    },
    {
      id: "A003",
      type: "高温",
      ...
      location: "木里县水洛乡",
      device: "水洛乡气象站",
      timestamp: "2025-06-02 10:20:15",
      status: "未处理",
      description: "水洛乡气象站检测到区域温度异常升高，已超过预警阈值。",
    },
    {
      id: "A004",
      type: "干旱",
      ...
      status: "已处理",
      description: "屋斯乡连续14天无降水，区域火险等级提升至中级。",
    },
    {
      id: "A005",
      type: "火情",
      ...
      location: "木里县瓦厂林区",
      device: "无人机巡检",
      timestamp: "2025-06-02 10:10:45",
      status: "处理中",
      description: "无人机巡检发现瓦厂林区有明火点，面积约50平方米，正在蔓延。",
      image: "/fire-alert-2.jpg",
    },
    {
      id: "A006",
      type: "设备",
      ...
      location: "木里县项脚乡",
      device: "项脚乡监测站",
      timestamp: "2025-06-02 10:05:30",
      status: "已关闭",
      description: "项脚乡监测站离线，可能存在设备故障，请检查。",
    },
    {
      id: "A007",
      type: "烟雾",
      ...
      location: "木里县彝海自然保护区",
      device: "彝海保护区监控点",
      timestamp: "2025-06-02 10:00:15",
      status: "已处理",
      description: "彝海保护区监控点检测到烟雾，经确认为农户正常生活用火，不存在火灾隐患。",
    },
    {
      id: "A008",
      type: "高温",
      ...
      location: "木里县城周边林区",
      device: "木里县城传感器组",
      timestamp: "2025-06-02 09:55:00",
      status: "未处理",
      description: "木里县城传感器组检测到区域温度持续升高，当前温度38°C，已超过预警阈值。",
    },
  ])
  ...
  const filteredAlerts = alerts.filter((alert) => {
    ...
    if (activeTab !== "all" && activeTab === "ignored" && alert.status !== "已关闭") return false
  ...
  const alertStats = {
    ...
    processed: alerts.filter((a) => a.status === "已处理" || a.status === "已关闭").length,
  ...
  // 添加一个函数来获取对应的英文文件名
  const getTypeImageName = (type: string) => {
    switch (type) {
      case "火情":
        return "fire"
      case "烟雾":
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">火情预警管理</h1>
            <p className="text-slate-400">查看和处理火情预警信息</p>
          </div>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={typeFilter} onValueChange={setTypeFilter}>
                    ...
                    <SelectContent className="bg-slate-700 border-slate-600">
                      ...
                      <SelectItem value="火情">火情</SelectItem>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm">全部告警</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-500">{alertStats.unprocessed}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-500">{alertStats.processing}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-500">{alertStats.processed}</p>
              </div>
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm">高危告警</p>
                <p className="text-2xl font-bold text-red-500">{alertStats.high}</p>
              </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="relative bg-gray-100 rounded-lg overflow-hidden">
                    <img
                      src={`/thermal-${getTypeImageName(selectedAlert!.type)}.jpg`}
                      alt="热成像图"
                      className="w-full h-64 object-cover"
                    />
                    ...
                    <div className="absolute top-2 left-2">
                      <Badge className="bg-slate-800/80">热成像图</Badge>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <p className="text-sm text-slate-400">告警设备</p>
                      <div className="flex items-center gap-2">
                        {getTypeIcon(selectedAlert.type)}
                        <span>{selectedAlert.device}</span>
                      </div>
                    </div>
                    <div>
              ...
              <div className="flex justify-end gap-2">
                ...
                {(selectedAlert.status === "已处理" || selectedAlert.status === "已关闭") && (
            ...
            {selectedAlert && (
              <div className="p-3 bg-slate-700 rounded-md">
                ...
                <div className="text-sm text-slate-400">
                  <span>{selectedAlert.timestamp}</span> · <span>{selectedAlert.location}</span>
                </div>
              </div>
            )}
