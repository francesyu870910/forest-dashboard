...
export default function AppLayout({ children, currentPage, onPageChange }: AppLayoutProps) {
  ...
  const headerBgClass = "bg-white border-gray-200"
  const textColorClass = "text-gray-600"
  const dropdownBgClass = "bg-white border-gray-200 text-gray-700"
  const dropdownHoverClass = "hover:bg-gray-100"
  const separatorClass = "bg-gray-200"
  const dialogBgClass = "bg-white border-gray-200 text-gray-900"
  const dialogDescClass = "text-gray-500"
  ...
  const iconClass = "text-gray-400 hover:text-gray-600"
  const outlineBtnClass = "bg-white text-gray-700 border-gray-300 hover:bg-gray-100"
  ...
  const menuItems = [
    { id: "dashboard", label: "森林监测总览", icon: Activity },
    { id: "events", label: "火情事件", icon: Search },
    { id: "tasks", label: "巡护任务", icon: Users },
    { id: "targets", label: "林区管理", icon: Shield },
    { id: "monitoring", label: "监控点位", icon: Bell },
    { id: "alerts", label: "火情预警", icon: Bell },
    ...
    <div className={`min-h-screen ${bgClass}`}>
      ...
      <header className={`p-4 border-b ${headerBgClass}`}>
        <div className="flex items-center justify-between mb-2">
          ...
          <div className={`flex items-center gap-4 text-sm ${textColorClass}`}>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div
                  className="flex items-center gap-1 px-3 py-1 rounded-lg cursor-pointer bg-gray-100 hover:bg-gray-200"
                >
              ...
              <DropdownMenuContent className={dropdownBgClass}>
                <DropdownMenuItem
                  className={`cursor-pointer ${dropdownHoverClass}`}
                ...
                <Button
                  ...
                  className={
                    isActive
                      ...
                      : "text-gray-700 border-gray-300 bg-white hover:bg-gray-100 hover:text-gray-900 hover:border-gray-400 active:bg-gray-200 whitespace-nowrap"
                  }
      ...
      <Dialog open={changePasswordOpen} onOpenChange={setChangePasswordOpen}>
        <DialogContent className={dialogBgClass}>
          ...
          {changeError && (
            <div
              className="flex items-center gap-2 p-3 bg-red-100 border border-red-300 text-red-800 rounded-md text-sm mb-4"
            >
              ...
              <div className="space-y-4 py-2">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Lock
                      className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 ${iconClass}`}
                    />
                    <Input
                      id="current-password"
