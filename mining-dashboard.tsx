        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold">森林防火监控平台</span>
            </div>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-slate-400 text-sm">监测面积</p>
                  <div className="flex items-baseline gap-2">
                    <span className="text-2xl font-bold">2,847</span>
                    <span className="text-sm text-slate-400">平方公里</span>
                  </div>
          ...
          <Card className="bg-slate-800 border-slate-700 h-80">
            ...
            <CardContent className="flex items-center justify-center h-48">
              <div className="text-center text-slate-400">
                ...
                <p className="text-lg">森林监测数据图表区域</p>
                <p className="text-sm">实时显示日/周/月监测趋势</p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1 mb-1">
                    ...
                    <span className="text-xs text-slate-400">风速km/h</span>
                  </div>
